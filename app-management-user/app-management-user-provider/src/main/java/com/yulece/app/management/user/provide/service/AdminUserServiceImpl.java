...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    public AdminUserVo getById(Integer id) {
        ...
        BeanValidator.checkObjectNull(adminUser,ExceptionEnum.QUERY_ERROR);
        return PojoConvertUtil.convertPojo(adminUser, AdminUserVo.class);
    }
    ...
    public boolean  update(AdminUserParam param) {
        ...
        int count = adminUserRepository.updateByPrimaryKeySelective(updateUser);
        return count > 0;
    }
    ...
    public boolean active(String key) {
        ...
        BeanValidator.checkObjectNull(eMail,AppParamEnum.USER_ACTIVE_KEY_ERROR);
        //根据邮箱查询用户
        AdminUser user = adminUserRepository.findAdminUserByMail(eMail);
        BeanValidator.checkObjectNull(user,AppParamEnum.USER_NOT_EXIST_ERROR);
    ...
    @Override
    public Page getList(AdminUserParam param) {
